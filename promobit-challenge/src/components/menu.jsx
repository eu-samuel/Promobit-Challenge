        ...
        <section className="bg-[#2D0C5E] h-[55vh] flex flex-col gap-[2vh] items-center justify-center font-roboto">
            ...
            <ul className="grid grid-cols-10 text-center gap-[1vw] mt-[2vh] mb-[2vh]">
                {genresList.map((item, index) => {
                    return (
                        <>
                            <button key={index} onClick={() => props.setGenre(item)} className={props.genre === item ? 
                            "bg-orange-500 text-white rounded-[.3vw] flex items-center justify-center min-w-[6vw] p-[.5vw] h-[5vh] cursor-pointer active:scale-[0.99]"
                            
                            :
                            
                            "bg-white text-black rounded-[.3vw] flex items-center justify-center min-w-[6vw] p-[.5vw] h-[5vh] cursor-pointer active:scale-[0.99]"}
                            >
